...
У `chgksuite` есть два режима работы — полностью консольный и консольный с элементами GUI. **Вы можете просто запускать скрипты или бинарные файлы и следовать инструкциям на экране**. Нижеследующая инструкция относится к консольному режиму.
